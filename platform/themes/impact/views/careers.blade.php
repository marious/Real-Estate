    ...
    <div class="bgheadproject hidden-xs mb-5">
        <div class="description mb-5">
            <div class="container-fluid w90">
                <h1 class="text-center mt-4"> انضم الينا</h1>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-lg-12 col-md-12">
                    <h3 class="mb-4" style="text-align: center">انضم الى فريق عمل Impact Investments</h3>
                    ...
                    <form action="{{ route('public.send.contact') }}" method="post" class="generic-form">
                        ...
                        <div class="form-group">
                            <div class="fakefile">
                                <button type="button" class="btn" style="display:block;width:120px; height:30px;" onclick="document.getElementById('getFile').click()">
                                    ارفق ال CV
                                </button>
