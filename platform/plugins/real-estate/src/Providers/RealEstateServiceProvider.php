...
use Botble\RealEstate\Repositories\Caches\InteractiveMapCacheDecorator;
...
use Botble\RealEstate\Repositories\Eloquent\InteractiveMapRepository;
...
class RealEstateServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton(InteractiveMapInterface::class, function () {
            return new InteractiveMapCacheDecorator(
                new InteractiveMapRepository(new InteractiveMap)
            );
        });
        ...
        Event::listen(RouteMatched::class, function () {
            dashboard_menu()
                ...
                ->registerItem([
                    ...
                    'name'        => 'plugins/real-estate::interactiveMap.name',
                    'icon'        => null,
                    'url'         => route('interactiveMap.index'),
                    'permissions' => ['interactiveMap.index'],
                ])
                ->registerItem([
                    'id'          => 'cms-plugins-property',
                    'priority'    => 0,
