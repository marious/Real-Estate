...
Route::group(['namespace' => 'Botble\RealEstate\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    ...
    Route::group([
        ...
        Route::group(['prefix' => 'interactive_map', 'as' => 'interactiveMap.'], function () {
            Route::resource('', 'InteractiveMapController')
                    ->parameters(['' => 'interactiveMap']);

            Route::delete('items/destroy', [
                'as'         => 'deletes',
                'uses'       => 'InteractiveMapController@deletes',
                'permission' => 'interactiveMap.destroy',
            ]);
